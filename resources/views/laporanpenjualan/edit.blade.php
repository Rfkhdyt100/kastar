...
@section('title', 'Edit Laporan Penjualan')
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-12">
            <div>
                <h3 class="text-center my-4">Edit Laporan Penjualan</h3>
                <hr>
            </div>
            <div class="card border-0 shadow-sm rounded">
                <div class="card-body">
                    <form action="{{ route('laporan_penjualans.update', $laporanPenjualan->id_laporan_penjualan) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   id="id_penjualan" 
                                   name="id_penjualan" 
                                   value="{{ old('id_penjualan', $laporanPenjualan->id_penjualan) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" 
                                   ...
                                   value="{{ old('tanggal_laporan', $laporanPenjualan->tanggal_laporan) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('total_pendapatan_laporan', $laporanPenjualan->total_pendapatan_laporan) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('jumlah_transaksi_laporan', $laporanPenjualan->jumlah_transaksi_laporan) }}" 
